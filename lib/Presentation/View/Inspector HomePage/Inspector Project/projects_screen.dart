...
class InspectorProjectListScreen extends StatefulWidget {
  @override
  _InspectorProjectListScreenState createState() => _InspectorProjectListScreenState();
}

class _InspectorProjectListScreenState extends State<InspectorProjectListScreen> {
          ...
          Padding(
            ...
            child: Row(
              children: [
                  ...
                  child: Padding(
                    ...
                    child: TextField(
                      ...
                      decoration: const InputDecoration(
                        labelText: 'Search Project name or Code',
                ...
                //       hint: const Text('Maintenance Status'),
                //       isExpanded: true,
                //       items: [
                //         const DropdownMenuItem(value: null, child: Text('All')),
                //         // Adjust these values based on actual MaintenanceStatus.name values from API
                //         const DropdownMenuItem(value: '3 months wise', child: Text('3 Months Wise')),
                //         const DropdownMenuItem(value: '6 months wise', child: Text('6 Months Wise')),
                //         const DropdownMenuItem(value: 'Yearly', child: Text('Yearly')),
                //       ],
                //       onChanged: (String? newValue) {
                //         setState(() {
                //           _selectedMaintenanceStatus = newValue;
                //           _filterProjects();
                //         });
                //       },
                //       decoration: const InputDecoration(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xFF679590),
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return Padding(
          ...
          _buildInfoColumn('Client', project.client.name, Icons.business),
          _buildInfoColumn('Branch', project.branch?.name ?? '-', Icons.branding_watermark),
