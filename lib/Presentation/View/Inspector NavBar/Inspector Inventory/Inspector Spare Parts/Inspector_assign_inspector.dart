...
//
// class SparePart_InspectorAssign extends StatefulWidget {
//   final String teamId;
//
//   const SparePart_InspectorAssign({Key? key, required this.teamId}) : super(key: key);
//
//   @override
//   _SparePart_InspectorAssignState createState() => _SparePart_InspectorAssignState();
// }
//
// class _SparePart_InspectorAssignState extends State<SparePart_InspectorAssign> {
...
//
//
// class SpareParts_AssignProject extends StatefulWidget {
//   const SpareParts_AssignProject({super.key, required this.teamId});
//
//   final String teamId;
//
//   @override
//   _SpareParts_AssignProjectState createState() => _SpareParts_AssignProjectState();
// }
//
// class _SpareParts_AssignProjectState extends State<SpareParts_AssignProject> {
...
class SpareParts_InspectorAssignProject extends StatefulWidget {
  const SpareParts_InspectorAssignProject({super.key, required this.teamId});

  final String teamId;

  @override
  _SpareParts_InspectorAssignProjectState createState() => _SpareParts_InspectorAssignProjectState();
}

class _SpareParts_InspectorAssignProjectState extends State<SpareParts_InspectorAssignProject> {
  List<Project> _projects = [];
