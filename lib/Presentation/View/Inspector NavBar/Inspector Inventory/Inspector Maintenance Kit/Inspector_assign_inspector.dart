...
//
// class MaintenanceInspectorAssignment extends StatefulWidget {
//   final String teamId;
//
//   const MaintenanceInspectorAssignment({Key? key, required this.teamId}) : super(key: key);
//
//   @override
//   _MaintenanceInspectorAssignmentState createState() => _MaintenanceInspectorAssignmentState();
// }
//
// class _MaintenanceInspectorAssignmentState extends State<MaintenanceInspectorAssignment> {
...
//         Uri.parse('https://backend.johkasou-erp.com/api/v1/inspector-assign-in-team'),
//         headers: {
...
//   }
//
//   Future<void> assignInspector() async {
//     if (selectedInspectorId == null) {
//       ScaffoldMessenger.of(context).showSnackBar(
//         const SnackBar(content: Text('Please select an inspector')),
//       );
//       return;
//     }
//
//     try {
//       final token = await TokenManager.getToken();
//       print('Assigning inspector to team: ${widget.teamId}'); // Debug print
//
//       // Fix: Change the payload structure to use user_ids array
//       final response = await http.post(
//         Uri.parse('https://backend.johkasou-erp.com/api/v1/assign-users-to-team/${widget.teamId}'),
//         headers: {
//           'Content-Type': 'application/json',
//           'Authorization': 'Bearer $token',
//         },
//         body: json.encode({
//           'user_ids': [selectedInspectorId], // Send as an array
//         }),
//       );
//
...
//           ScaffoldMessenger.of(context).showSnackBar(
//             const SnackBar(content: Text('Inspector assigned successfully')),
//           );
//         } else {
//           throw Exception(jsonData['message'] ?? 'Failed to assign inspector');
//         }
//       } else {
//         throw Exception('Failed to assign inspector');
//       }
//     } catch (e) {
//       print('Error assigning inspector: $e'); // Debug print
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(content: Text('Error assigning inspector: $e')),
//       );
//     }
//   }
//
...
//
//
// class MaintenanceAssignProject extends StatefulWidget {
//   const MaintenanceAssignProject({super.key, required this.teamId});
//
//   final String teamId;
//
//   @override
//   _MaintenanceAssignProjectState createState() => _MaintenanceAssignProjectState();
// }
//
// class _MaintenanceAssignProjectState extends State<MaintenanceAssignProject> {
...
//
//     try {
//       // Retrieve the token from your token manager
...
//
//       final response = await http.get(
//         Uri.parse('https://backend.johkasou-erp.com/api/v1/project-assign-in-team'),
//         headers: {
...
//   Future<void> assignProject() async {
...
//
//       final response = await http.post(
//         Uri.parse('https://backend.johkasou-erp.com/api/v1/assign-projects-to-team/${widget.teamId}'),
//         headers: {
//           'Authorization': 'Bearer $token',
//           'Content-Type': 'application/json',
//         },
...
//           "projects": [
//             {
//               "id": _selectedProject!.project_id, // Use the selected project ID
//             }
//           ],
//         }),
//       );
...
//         );
//       } else {
//         // Handle the case where the assignment fails
//         ScaffoldMessenger.of(context).showSnackBar(
//           SnackBar(content: Text('Failed to assign project: ${response.statusCode}')),
//         );
//       }
//     } catch (e) {
//       print('Error: $e');
...
//                   children: [
//                     // Dropdown button for selecting a project
...
//                           value: project,
//                           child: Container(
//                             width: double.infinity, // Take full width of the dropdown
//                             child: Column(
...
//   @override
//   Widget build(BuildContext context) {
//     return TextButton.icon( icon: Icon(Icons.factory), onPressed: () {
...
class Inspector_MaintenanceInspectorAssignment extends StatefulWidget {
  final String teamId;

  const Inspector_MaintenanceInspectorAssignment({Key? key, required this.teamId}) : super(key: key);

  @override
  _Inspector_MaintenanceInspectorAssignmentState createState() => _Inspector_MaintenanceInspectorAssignmentState();
}

class _Inspector_MaintenanceInspectorAssignmentState extends State<Inspector_MaintenanceInspectorAssignment> {
  int? selectedInspectorId;
  List<Map<String, dynamic>> inspectors = [];
  bool isLoading = false;
  ...
  Future<void> fetchInspectors() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('${DaikiAPI.api_key}/api/v1/inspector-assign-in-team'),
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $token',
        },
